    ...
    <ThemeProvider theme={theme}>
      <Container component="main" maxWidth="xs">
        ...
        >
          ...
          <div className='text-slate-400 font-medium mb-5'>You have successfully verified account</div>
          <Button variant='contained' color='secondary' sx={{ color: 'white' }}>Ok</Button>
        </Box>
      </Container>
    </ThemeProvider>
  );
