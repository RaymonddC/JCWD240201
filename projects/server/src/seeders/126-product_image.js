...
module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    await queryInterface.bulkInsert('product_images', [
      ...
      {
        product_id: 5,
        image: 'public/product_images/cendo_fenicol_0,25_tetes_mata_5_ml.jpeg',
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
      ...
      {
        product_id: 32,
        image: 'public/product_images/tolak angin madu.png',
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
      ...
      {
        product_id: 20,
        image: 'public/product_images/trisela.jpeg',
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        product_id: 21,
        image: 'public/product_images/tolak-angin-cair-flu.jpg',
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
